    ...
    **Example**:
    ...
    def _write_local_data_files(self, cursor):
        ...
        for row in cursor:
            ...
            s = json.dumps(row_dict, sort_keys=True, ensure_ascii=False).encode('utf-8')
    ...
    def _write_local_schema_file(self, cursor):
        ...
        s = json.dumps(schema, sort_keys=True, ensure_ascii=False).encode('utf-8')
